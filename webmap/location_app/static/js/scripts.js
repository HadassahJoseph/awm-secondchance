...
//     var lat = {{ location.latitude|escapejs }};
//     var lon = {{ location.longitude|escapejs }};
//     var name = "{{ location.name|escapejs }}";
//     var year = "{{ location.year|escapejs }}";
//     var city = "{{ location.city|escapejs }}";
//     var region = "{{ location.region|escapejs }}";
//     var cuisine = "{{ location.cuisine|escapejs }}";
//     var star_level = "{{ location.star_level|escapejs }}";
